...
def bot_message(m):
    if m.contact is not None:
        """
            Если мерчант не зарегистрирован в Базе, то после нажатие
        ...
        """
            ...
            инлайн URL кнопки новых заказо, при нажатие на эти URL кнопки
            происходит переход на Админ панель в страницу заказа
        """
